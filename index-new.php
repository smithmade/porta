...
<div id="wrapper">
  ...
  <div id="tumblelog">
    ...
    <div class="item col1"><img src="instagram/13/5.jpg" alt="" /></div>
    ...
    <div class="item col2"><a class="fancybox" target="_blank" href="images/back-to-the-earth.jpg" ><img src="images/back-to-the-earth-438.svg" alt="Back to Earth"></a></div>
    <div class="item col1"><img src="instagram/13/2.jpg" alt="" /></div>
    <div class="item col1"><img src="instagram/13/12.jpg" alt="" /></div>
    <div class="item col1"><img src="instagram/13/7.jpg" alt="" /></div>
    <div class="item col1"><img src="instagram/13/6.jpg" alt="" /></div>
    <div class="item col1"><img src="instagram/13/8.jpg" alt="" /></div>
    <div class="item col1"><img src="instagram/13/4.jpg" alt="" /></div>
    <div class="item col2">
        <!-- slider -->
    ...
    <div class="item col1 up-more"><img src="instagram/13/1.jpg" alt="" /></div>
    <div class="item col1 up"><img src="instagram/13/9.jpg" alt="" /></div>
    <div class="item col1"><img src="instagram/13/16.jpg" alt="" /></div>
    <div class="item col1"><img src="instagram/13/11.jpg" alt="" /></div>
    <div class="item col1"><img src="instagram/13/10.jpg" alt="" /></div>
    </div>
    </div>

...
<!-- 438 -->
    ...
    <div class="item col2">
      <!--  <img src="images/lucky-number-7-438.jpg" alt=""> -->
      <!-- 438 slider -->
        <div class="flexslider four-thirty-eight">
          <ul class="slides">

            <li>
              <a class="fancybox" href="images/little-italy-love.jpg"><img src="images/little-italy-love-438.jpg" alt=""></a>
            </li>

            <li>
              <a class="fancybox" href="images/mardi-gras.jpg"><img src="images/mardi-gras-438.jpg" alt=""></a>
            </li>
